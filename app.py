...
gdf = gpd.read_file("zonas_OD.shp")
od_df = pd.read_csv("matriz_od.csv")  # Assumindo que convertamos o DataFrame para CSV

# Centroides das zonas para ligacao OD
gdf_centroids = gdf.copy()
gdf_centroids["geometry"] = gdf_centroids.centroid

# Mapear origem e destino para coordenadas
...
# Adicionar colunas de coordenadas ao DataFrame OD
